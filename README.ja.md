...
![配布者がユーザーにトークンを配布](./docs/sequence-diagram/from-distributor-to-user.svg)
...
![ユーザーがトークン交換（ポイントの消費）の申請を行う](./docs/sequence-diagram/request-and-accept-token-transfer.svg)
